    ...
    <div className={styles.main}>
      <div className={styles.starBg}>
        <div className={styles.star}>
          <img ref={starRef} style={{ transform: 'translate(0, 0)' }} className='w-full h-full' src={getImage('star.png')} alt="" />
        </div>
        <div className={styles.supe}>
          <img ref={supeRef} style={{ transform: 'translate(0, 0)' }} className='w-full h-full' src={getImage('supe.png')} alt="" />
        </div>
      </div>
    </div>
  )
